...
namespace n11
{
    ...
    public class n11
    {
        ...
        public void SearchBilgisayar()
        {
            ...
            Assert.IsTrue(Search_Result_Text.Text.Contains("Bilgisayar"));
            Thread.Sleep(4000);
            Console.WriteLine("Bilgisayar için arama sonuçları listelendi.");
        ...
        public void SepeteAt()
        {
            ...
            IWebElement SelectBox = driver.FindElement(By.XPath(".//*[@id='quantity']"));
            IWebElement SelectQuantity = SelectBox.FindElement(By.TagName("select"));

            SelectElement selectAdet = new SelectElement(SelectQuantity);
            selectAdet =+ selectAdet;
            Console.WriteLine("Ürün Adedi Artırıldı...");

            IWebElement Btn_Basket = driver.FindElement(By.CssSelector(".btn.btnAdet.btnAddBasket"));
            Btn_Basket.Click();
            Thread.Sleep(3000);
